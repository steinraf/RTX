...
public:
    ...
    __host__ __device__ Vector3f(float e0, float e1, float e2) { e[0] = e0; e[1] = e1; e[2] = e2; }
    ...
    __host__ __device__ inline Vector3f operator-() const { return Vector3f(-e[0], -e[1], -e[2]); }
